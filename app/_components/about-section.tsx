    ...
    <div className="animate-[numi-in_300ms_ease_both] flex flex-col gap-14 pt-4">
      <section className="" style={{ display: 'flex' }}>
        ...
        >
          ...
          <p className="font-serif italic text-[21px] m-0 text-[#C06A43]">
            Founder &amp; Lead Developer, NUMI
          </p>
          <p className="text-[18px] leading-[1.7] m-0 max-w-[32em] text-[#4A403A]">
            I build web and mobile products, internal tools, and the systems
            businesses run on. Before NUMI, I spent my time building software
            used by a lot of people at once — which is mostly where I learned to
            ask what a thing is for before building it.
          </p>
        ...
        <div
          className="flex flex-col gap-[14px] min-w-0"
          style={{ flexBasis: '33%' }}
        >
          <div
          ...
          >
            <CldImage
              src="OFFICIAL_PROFILE_PIC" // Use this sample image or upload your own via the Media Library
          ...
          <div className="bg-white border border-[#EBE1D6] rounded-[22px] p-6 flex flex-col gap-4">
            ...
            <div>
              <p className="font-bold text-[17.5px] m-0 mb-1">
                Snap Inc. — Software Engineer
              </p>
              <p className="text-base leading-[1.6] m-0 text-[#5F534B]">
                Snapchat for Web, My AI, and Snap Ads. Web experiences and
                shared UI systems.
              </p>
            </div>
            <div>
              <p className="font-bold text-[17.5px] m-0 mb-1">
                Sandia National Laboratories — Software Engineer
              </p>
              <p className="text-base leading-[1.6] m-0 text-[#5F534B]">
                Built 200+ internal web pages and raised accessibility
                compliance from 35% to 95%.
              </p>
            </div>
            <button
              onClick={onOpenSnap}
      ...
      <section className="relative overflow-hidden bg-[#241C18] rounded-[26px] p-[clamp(30px,4.6vw,60px)] flex flex-col gap-[18px] items-start">
        ...
        <h2 className="relative font-bold text-[clamp(27px,4vw,44px)] leading-[1.06] tracking-[-0.025em] m-0 max-w-[22em] text-[#FBF5EF]">
          ...
          <span className="font-serif italic font-normal text-[#F6CB96]">
            better.
          </span>
        </h2>
        <p className="relative text-[18.5px] leading-[1.65] m-0 text-[#D9CDC3] max-w-[32em]">
          Have an idea? Have a business that&apos;s becoming harder to run?
          Let&apos;s figure out what technology can do about it.
        </p>
        <button
          onClick={onBook}
        ...
        <span className="relative text-[15.5px] text-[#A6968B]">
